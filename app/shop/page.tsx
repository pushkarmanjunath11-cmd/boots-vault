...
const cats = [
  { id:'all',            label:'All' },
  { id:'football-boots', label:'Football FG/AG' },
  { id:'turf',           label:'Turf' },
    ...
    <div style={{ background:'var(--bg)', minHeight:'100vh', paddingTop:68, fontFamily:'Montserrat,sans-serif' }}>
      ...
      <div style={{ background:'var(--bg2)', borderBottom:'1px solid var(--border)', padding:'40px 48px 0' }}>
        <div style={{ maxWidth:1200, margin:'0 auto' }}>
          ...
          <h1 className="font-display" style={{ fontSize:'clamp(48px,7vw,88px)', color:'var(--white)', lineHeight:0.9, marginBottom:28 }}>ALL BOOTS</h1>
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'32px 48px' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24, gap:12, flexWrap:'wrap' }}>
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            ...
            <span style={{ fontSize:12, color:'rgba(242,242,237,0.3)' }}>{filtered.length} boots</span>
          </div>
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign:'center', padding:'80px 0' }}>
            <p className="font-display" style={{ fontSize:36, color:'rgba(242,242,237,0.08)', marginBottom:12 }}>NO BOOTS FOUND</p>
