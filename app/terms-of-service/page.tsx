    ...
    <div style={{ background:'var(--bg)', minHeight:'100vh', paddingTop:68, fontFamily:'Montserrat,sans-serif' }}>
      <div style={{ maxWidth:800, margin:'0 auto', padding:'60px 40px' }}>
        ...
        {[
          ...
          { title:'2. Products & Authenticity', content:`All products sold on Boots Vault are mastercopies with identical quality and texture to original elites. Product images are for illustration purposes and may slightly differ from the actual product. We reserve the right to limit quantities, discontinue products, or modify prices at any time without prior notice.` },
